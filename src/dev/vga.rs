...
impl VGA {
    pub fn new(bus: u8, slot: u8) -> Result<VGA, PCIError> {
        ...
        {
            let vga = VGA {              
                fb: 0x5000_0000 as *mut u8,
                fb_size: pci.get_bar_size(0) as usize,
                io: (0x5000_0000 as usize + pci.get_bar_size(0) as usize) as *mut u8,
                io_size: pci.get_bar_size(2) as usize,
                pci: pci,
            };
    ...
    pub unsafe fn set_mode13(&self) {
        unsafe {
            let port0300: *mut u8 = self.io.add(0x400 - 0xC0);
